...
class Piano: #1206,730 - new 1206,130   ->  1540,800 -sa set_mode  1540,200 - sa piano
    ...
    def __init__(self) -> None:
        ...
        pg.midi.init()
        self.running = True
        self.display = pg.display.set_mode((1206,730))
        self.rectList = []
        self.iterVal = 0
        ...
        self.white_pressed_surface = pg.surface.Surface((1206,130),
        pg.SRCALPHA, 32).convert_alpha()

        self.black_pressed_surface = pg.surface.Surface((1206,130),
        pg.SRCALPHA, 32).convert_alpha()
 ...
 # ----------------------------------------------------------------------------------------
    ...
    def create_key_surfaces(self):
        ...
        black_keys = pg.surface.Surface(
            (1206,130), pg.SRCALPHA, 32).convert_alpha()
...
pn = Piano()
display = pg.display.set_mode((1206,730))
while pn.running:
