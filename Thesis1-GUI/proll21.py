...
class pRoll:
    ...
    def __init__ (self) -> None:
        ...
        self.midiFile = None ## addons ulets
        
        # Attribute for transcribing the MIDI file 
        self.transcribed_song = None
        ...
        for msg in song: # Loop inside the MIDI File [from transcribe class]
            ...
            if not msg.is_meta:  # If message is a META Data
                ...
                if msg.type == "note_off" or msg.type == "note_on" and msg.velocity == 0:
                    ...
                    note_index = self.index_of_note(note,playing_notes)
    ...
    def index_of_note(self,note,arr) -> int:
       ...
       # pg.init()
        ...
        for e in events:
            ...
            if e.type in [pg.midi.MIDIIN]:
                ...
                time = round((e.__dict__['timestamp'] / 1000))
                ...
                if stat!=128:
                    ...
                    if val in keyCoordinates.keys():
                        ...
                        pg.draw.rect(self.piano.white_pressed_surface,
                                (255, 165, 0, 200), (keyCoordinates.get(val), 0, 45, 207), border_radius=5)
                # "Gap" animation between the keys
                        pg.draw.rect(self.piano.white_pressed_surface, (255, 165, 0),
            ...
            surface.blit(self.piano.white_key_surface, (0, 600))  # Draw the UNPRESSED white key
            surface.blit(self.piano.white_pressed_surface, (0, 600))  # Draw the PRESSED white Key
            surface.blit(self.piano.black_key_surface, (0, 600))  # Draw the UNPRESSED black key
            surface.blit(self.piano.black_pressed_surface, (0, 600))  # Draw the PRESSED black key
